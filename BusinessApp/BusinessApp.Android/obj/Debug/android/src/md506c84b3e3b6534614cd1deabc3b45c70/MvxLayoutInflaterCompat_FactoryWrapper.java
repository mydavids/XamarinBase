...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Binding.Droid.Binders.MvxLayoutInflaterCompat+FactoryWrapper, MvvmCross.Binding.Droid, Version=5.0.1.0, Culture=neutral, PublicKeyToken=null", MvxLayoutInflaterCompat_FactoryWrapper.class, __md_methods);
	}
	...
	public MvxLayoutInflaterCompat_FactoryWrapper () throws java.lang.Throwable
	{
		...
		if (getClass () == MvxLayoutInflaterCompat_FactoryWrapper.class)
			mono.android.TypeManager.Activate ("MvvmCross.Binding.Droid.Binders.MvxLayoutInflaterCompat+FactoryWrapper, MvvmCross.Binding.Droid, Version=5.0.1.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
